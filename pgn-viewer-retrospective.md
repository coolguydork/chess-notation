...
- [ ] Task 0 — Invariants (no code; read + keep handy)
- [ ] Task A — Establish the `src/view/` layer (do before Task 1)
- [ ] Task B — Relocate move-tree builders to `core/tree.ts` (do before Task 1)
- [ ] Task 1 — `PgnViewerState` + skeleton (→ A, B)
- [ ] Task 2 — Stable DOM + single-writer board
- [ ] Task 3 — `render()` (nav + move list only) (→ 2)
- [ ] Task 4 — Transition methods (→ 2, 3)
- [ ] Task 5 — Event delegation (→ 4)
- [ ] Task 6 — Observer hook (→ 4)
- [ ] Task 7 — Position cache (re-mount survival) (→ 6)
- [ ] Task 8 — Write-back firing rules (→ 6)
- [ ] Task 9 — Hover preview / flicker fix (→ 2)
- [ ] Task 10 — Extract slide animation (→ 2)
- [ ] Task 11 — Game selector / `loadGame` (→ 6)
- [ ] Task 12 — Preserve user arrows (→ 2)
- [ ] Task 13 — Engine-ready move path (→ 4)
- [ ] Task 14 — Obsidian lifecycle + integration (→ 6, 7, 8)
- [ ] Task 15 — Tests (→ 4, 6)
- [ ] Final verification gate (all of the above)
